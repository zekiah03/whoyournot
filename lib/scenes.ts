...
export const SCENES: Scene[] = [
  ...
  { id: 5, category: "記憶", text: "あなたを今の形にした、人生で最も重い挫折の記憶だけが抜け落ちている。失敗の痛みを知らない、別の人格としてあなたは生きている。", tags: { 記憶: 40, 価値観: 60, 意識: 100, 体: 100 } },
  // ■体系
  ...
  { id: 59, category: "体", text: "痛みを一切感じない体になっている。切り傷や火傷に気づかず、体はいつの間にか損なわれていく。", tags: { 体: 40, 意識: 80 } },
  { id: 60, category: "体", text: "あなただけが老いない。家族も友人も年を取って去っていき、あなたは同じ顔のまま残り続ける。", tags: { 体: 90, 時間: 30, 関係: 20 } },
  ...
  { id: 85, category: "価値観", text: "全ての人・物を等しく愛している。特別な誰か、大切な何かという感情が消えている。", tags: { 価値観: 20, 関係: 20 } },
