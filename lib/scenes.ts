...
export const SCENES: Scene[] = [
  ...
  // ■新規追加（欠けていた角度）
  { id: 101, category: "記憶", text: "あなたが過去に誰かを深く傷つけた証拠がある。しかし、あなたはその行為を一切覚えていない。それは\u201cあなた\u201dの行為か。", tags: { 記憶: 30, 価値観: 70, 存在: 60 } },
  { id: 102, category: "体", text: "最も愛する人（恋人・親友・家族）の体で目覚めている。あなたの体では、その人が生きている。", tags: { 体: 0, 意識: 100, 記憶: 100, 関係: 20 } },
  { id: 103, category: "時間", text: "1日に1%ずつ、別人になっていく。10年後、元のあなたは一欠片も残っていない。境界線はどこにあったのか。", tags: { 時間: 20, 記憶: 30, 価値観: 30, 意識: 50 } },
  { id: 104, category: "境界", text: "家族も友人も、あなたを別人として扱っている。あなただけが「自分は自分だ」と信じ続けている。", tags: { 関係: 0, 存在: 30, 意識: 100 } },
  { id: 105, category: "体", text: "母語を完全に失い、学んだこともない言語しか話せない。思考もその言語で行われる。", tags: { 意識: 60, 記憶: 70, 体: 80 } },
];
